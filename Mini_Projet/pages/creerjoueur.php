    ...
    <div class="div-creer-joueur">
        ...
        <div class="div-file">
            <img class="avatar-img-j" src="../Images/avatar/admin.jpg" alt="">
            <label class="div-avatar-joueur" for="">Avatar du joueur</label>
        </div>
        <form action="" method="post"><br>
            <label class="div-label-joueur" for="">Prenom</label><br>
            <input class="div-input-joueur" type="text" name="prenom" id="" placeholder=" Entrer votre prenom"><br>
            <label class="div-label-joueur" for="">Nom</label><br>
            <input class="div-input-joueur" type="text" name="nom" id="" placeholder="Entrer votre nom"><br>
            <label class="div-label-joueur" for="">Login</label><br>
            <input class="div-input-joueur" type="text" name="login" id="" placeholder="saisir un Login"><br>
            <label class="div-label-joueur" for="">Mot de passe</label><br>
            <input class="div-input-joueur" type="password" name="password" id="" placeholder="saisir votre password"><br>
            <label class="div-label-joueur" for="">Confirmer mot de passe</label><br>
            <input class="div-input-joueur" type="password" name="c_password" id="" placeholder=" veuillez Confirmer password"><br>
