...
<body>
        <form action="" methode="POST" style="margin-left:35%">
            ...
            <button style="background-color:skyblue; height:30px; width: 10%" name="valider" value="valider" type="submit">Valider</button> 
            <button style="background-color:red; margin-left:1%; height:30px; width: 10%" name="annuler" value="annulerr" type="button">Annuler</button> 
        </form>
<?php
