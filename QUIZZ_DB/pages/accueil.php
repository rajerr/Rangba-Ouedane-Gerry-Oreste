    ...
    <div class="container">
            <div class=" d-none d-md-block d-lg-block d-xlg-block col-4 float-left mt-4 menu">
               ...
               <label><img  class="icon" src="../assets/Images/Icônes/jeux.png" alt=""></label>
                    ...
                    <!--Navbar-->
            <nav class="navbar navbar-light  purple lighten-4 mb-4 bg-info d-md-none d-lg-none d-xlg-none">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <a class="nav-link" href="admin.php">Dashbord <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <ul class="navbar-nav">
                    <a class="nav-link" href="admin.php?lien=creation">Creer Admin</a>
                    <a class="nav-link" href="admin.php?lien=liste_joueur">Lister Joueurs</a>
                    </ul>
                </li>
                <li class="nav-item">
                    <ul class="navbar-nav">
                    <a class="nav-link" href="admin.php?lien=creer_question">Creer Questions</a>
                    <a class="nav-link" href="admin.php?lien=liste_question">Lister Questions</a>
                    </ul>
                </li>
            </ul>
            <!-- Links -->
